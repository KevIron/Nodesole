...
export default class OutputNode extends Node {
    constructor() {
        ...
        this.setTitle("Finishing Node");
        this.setClass("node-output");
    }

    _generateNodeTemplate() {
        return `
            <div class="node-body">
                <svg class="input-point" width="26" height="18" viewBox="0 0 13 9" fill="none" xmlns="http://www.w3.org/2000/svg">
